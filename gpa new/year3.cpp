...
double year3::TScredit = 0;
double year3::finalgpayear3 = 0;

year3::year3(QWidget *parent)
	: QWidget(parent)
{
	ui.setupUi(this);
}
...
void year3::semester5gpa()
{
	...
	subject9=ui.comboBox_41->currentText();
	subject10=ui.comboBox_42->currentText();
	subject11=ui.comboBox_43->currentText();
	subject12=ui.comboBox_44->currentText();
	subject13=ui.comboBox_45->currentText();
	subject14=ui.comboBox_46->currentText();
	subject15=ui.comboBox_47->currentText();
...
void year3::currentgpa()
{
	...
	if (y2!=0 && semester5!=0)
	{
		gpa=((y2*72.5)+(s5*selectcredit))/(72.5+selectcredit);

		TScredit=72.5+selectcredit;
		finalgpayear3=gpa;
